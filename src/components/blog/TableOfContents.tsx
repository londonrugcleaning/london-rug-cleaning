            ...
            {headings
              ...
              .map((heading, index) => (
                <AccordionItem key={index} value={`section-${index}`}>
                  <AccordionTrigger className="text-sm hover:no-underline hover:text-blue-900 py-2">
                    <a href={`#${heading.id}`} className="hover:text-blue-900">
                      {heading.text}
                    </a>
                  </AccordionTrigger>
                  ...
                  <AccordionContent>
                    <ul className="space-y-2 pl-4">
                      {headings
                        ...
                        .map((subheading, idx) => (
                          <li key={idx} className="text-sm text-muted-foreground hover:text-blue-900">
