  ...
  return (
    <>
      ...
      <div className="mb-8 rounded-lg border bg-muted/50 p-4 shadow-sm">
        <Button
          variant="ghost"
          className="mb-2 w-full justify-between text-blue-800"
            ...
            {headings
              ...
              .map((heading, index) => (
                <AccordionItem key={index} value={`section-${index}`}>
                  <AccordionTrigger className="text-sm hover:no-underline hover:text-blue-800 py-2">
                    <a href={`#${heading.id}`} className="hover:text-blue-800">
                      {heading.text}
                    </a>
                  </AccordionTrigger>
                  ...
                  <AccordionContent>
                    <ul className="space-y-2 pl-4">
                      {headings
                        ...
                        .map((subheading, idx) => (
                          <li key={idx} className="text-sm text-muted-foreground hover:text-blue-800">
